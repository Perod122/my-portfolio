  ...
  const skillCategories = [
    {
      ...
      title: "Languages",
      skills: ["C#", "Python", "JavaScript", "TypeScript", "HTML", "CSS", "PHP"],
    },
    {
      icon: <Server className="h-6 w-6" />,
      title: "Technologies / Tools",
      skills: ["Git", "GitHub", "VS Code", "Cursor AI", "Visual Studio", "Apache", "Linux"],
    },
    {
      icon: <Palette className="h-6 w-6" />,
      title: "Frameworks",
      skills: ["React", "Next.js", "Tailwind CSS", "Node.js", "Express JS", "Laravel", "Vite"],
    },
    {
      icon: <Brain className="h-6 w-6" />,
      title: "Other Skills",
      skills: ["Critical Thinker", "Problem-Solving Skills", "Adaptable", "Restful API Development"],
    },
  ]

  return (
    <section id="skills" className="py-10 relative scroll-mt-16">
