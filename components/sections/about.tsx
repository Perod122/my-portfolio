...
export default function About() {
  ...
  const quickFacts = [
    ...
    {
      icon: <ComputerIcon className="h-5 w-5 text-teal-400" />,
      title: "Tech Enthusiast",
      description: "Exploring emerging technologies and trends",
    },
    {
    ...
    },
    {
      ...
      title: "Guadalupe, Cebu City",
      description: "Based in Philippines",
    },
  ]

  return (
    <section id="about" className="py-10 relative scroll-mt-16">
